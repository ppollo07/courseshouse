...
export default function SobrePage() {
  return (
    <MainLayout>
      {/* Hero Section */}
      <section className="w-full bg-muted/50 py-8 sm:py-12 md:py-16">
        <div className="container px-3 sm:px-4 md:px-6 mx-auto max-w-5xl">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight mb-3 sm:mb-4">
              Sobre el Curso de Violencia de Género
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-3xl mb-6 sm:mb-8">
            ...
            <Card>
              ...
              <CardContent className="p-4 sm:p-5 pt-2 sm:pt-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    { num: 1, title: "Introducción y Conceptos Fundamentales", hours: 6 },
                    { num: 2, title: "Tipos y Manifestaciones de la Violencia de Género", hours: 10 },
                    { num: 3, title: "Magnitud del Problema: Datos y Estadísticas", hours: 6 },
                    { num: 4, title: "Causas y Factores de Riesgo", hours: 8 },
                    { num: 5, title: "Impacto y Consecuencias", hours: 6 },
                    { num: 6, title: "Marco Legal y Derechos", hours: 6 },
                    { num: 7, title: "Intervención y Servicios de Apoyo", hours: 8 },
                    { num: 8, title: "Prevención de la Violencia de Género", hours: 8 },
                    { num: 9, title: "Grupos Específicos y Violencias Interseccionales", hours: 2 },
                    { num: 10, title: "Conclusiones y Compromiso", hours: 0 }
                  ].map((module) => (
                    <div key={module.num} className="flex items-start p-3 border rounded-md bg-card/50">
                      <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 text-primary flex items-center justify-center mr-3">
                        <span className="text-xs font-bold">{module.num}</span>
                      </div>
                      <div>
      ...
      {/* CTA Section */}
      <section className="w-full bg-muted/50 py-6 sm:py-8 md:py-10">
        <div className="container px-3 sm:px-4 md:px-6 mx-auto max-w-5xl">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3">
              ¿Listo para comenzar?
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mb-4 sm:mb-5">
